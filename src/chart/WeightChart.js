...
const WeightChart = ({bmiValue,height,lower,upper,category}) => {
  ...
  return (
   ...
   <CategoryGraph range={"(Under 18)" } categoryName="UnderWeight" category={category} ></CategoryGraph>
   <CategoryGraph range={"(18.5-24.9)" } categoryName="Healthy" category={category}></CategoryGraph>
   <CategoryGraph range={"(25.0-29.9)" } categoryName="OverWeight" category={category} ></CategoryGraph>
   <CategoryGraph range={"(30.0 & above)" } categoryName="Obese" category={category} ></CategoryGraph>
    </div>
